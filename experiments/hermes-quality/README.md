...
配套 [两批仿真练习文字稿](two-batch-learning-fixture/README.md)：每批 10 题，含模拟批改，题干/学生作答与人工参考分开。A 卷图片累计三次未成功，B 尚未请求；文字分析进展见上。[旧六题合成样张](../generated-assets/README.md)已补入仓库，但不是新 A/B 卷。

## 此前单题实验归档

以下“本次”等时间措辞指各自归档时点，不否定上方学习故事 A/B/周报的新调用；旧 runner、候选与原始结果保留不变。
